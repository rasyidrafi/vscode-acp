...
/**
 * Generate the legacy inline HTML content for the webview.
 */
export function getLegacyChatWebviewHtml(webview: vscode.Webview): string {
        ...
        case 'promptEnd':
          ...
          if (currentAssistantText) {
            ...
            if (currentAssistantEl) {
              currentAssistantEl.classList.add('md-rendered');
